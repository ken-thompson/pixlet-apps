...
def main():
    ...
    CMC_API_KEY = "xxxxxxxx-xxxx-xxxx-xxxxx-xxxxxxxx" # API KEY GET YOUR OWN
            ...
            render.Row(
                ...
                children = [
                    ...
                    render.Column(
                      ...
                      expanded=True,
                      children=[
                        render.Text("$"+str(link_price), color=link_24h_color, height=7),
                        render.Text(str(link_24h_change)+"%", color=link_24h_color, height=7),
                        render.Text(str(link_7d_change)+"%", color=link_7d_color, height=7),
                      ]
                    )
